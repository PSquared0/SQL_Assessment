...
--
-- Name: awards; Type: TABLE; Schema: public; Owner: vagrant
--
...
ALTER TABLE awards OWNER TO vagrant;
...
ALTER TABLE brands_id_seq OWNER TO vagrant;
...
ALTER TABLE models_id_seq OWNER TO vagrant;
